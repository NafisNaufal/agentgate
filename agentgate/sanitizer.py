...
_REDACTIONS: list[tuple[re.Pattern[str], str]] = [
    (_PRIVATE_KEY_BLOCK_RE, "[REDACTED_PRIVATE_KEY]"),
    (secrets.PATTERNS[8][1], "[REDACTED_PRIVATE_KEY]"),  # PRIVATE KEY block
    ...
    (secrets.PATTERNS[7][1], "[REDACTED_JWT]"),
